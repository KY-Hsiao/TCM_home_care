...
export const visitRecordSchema = z.object({
  ...
  treatment_chinese_medicine_checked: z.boolean().optional().default(false),
  treatment_chinese_medicine_note: z.string().optional().default(""),
  treatment_acupuncture_checked: z.boolean().optional().default(false),
  treatment_acupuncture_note: z.string().optional().default(""),
  treatment_topical_medication_checked: z.boolean().optional().default(false),
  treatment_topical_medication_note: z.string().optional().default(""),
